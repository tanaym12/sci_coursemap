...
`?"\\n":"\\r"),a.singleQuotes===!1?(o=o.replace(/"/g,'\\"'),`"${o}"`):(o=o.replace(/'/g,"\\'"),`'${o}'`)}(e,t,n)}function*Oe(e,...t){let n=new Set,r;for(;(r=t.pop())!==void 0;)n.has(r)||(yield r,n.add(r),t.push(...e(r)))}function Ft(e,t){let n=[];for(let[r,i]of K(t))n.push(e[r]),n.push(i);return n.push(e[e.length-1]),n.join("")}function D(e,...t){let n=A(t,r=>Ht(r,{indent:"  ",singleQuotes:!1,inlineCharacterLimit:60}));return new Error(Ft(e,n))}function jn(e){return`internal error: ${e}; if you encounter this please submit an issue at: https://github.com/erikbrinkman/d3-dag/issues`}function te(e,...t){let n=A(t,r=>r.toString());return new Error(jn(Ft(e,n)))}function oe(e,t,...n){let[r,...i]=e,o=A(n,u=>u.toString()),a=Ft(i,o),s=t.name||"anonymous";return new Error("d3dagBuiltin"in t?jn(`builtin ${r}'${s}'${a}`):`custom ${r}'${s}'${a}`)}function*K(e){let t=0;for(let n of e)yield[t++,n]}function*Ne(e,t){for(let[n,r]of K(e))yield*Y(t(r,n))}function qn(e,t,n){let r=n;for(let[i,o]of K(e))r=t(r,o,i);return r}function*A(e,t){for(let[n,r]of K(e))yield t(r,n)}function*be(e,t){for(let[n,r]of K(e))t(r,n)&&(yield r)}function Zt(e,t){for(let[n,r]of K(e))if(t(r,n))return!0;return!1}function Hn(e,t){return!Zt(e,(n,r)=>!t(n,r))}function*Eo(e,t,n,r){let i=Math.min(n,e.length);for(let o=t;o<i;o+=r)yield e[o]}function*jo(e,t,n,r){let i=Math.max(n,-1);for(let o=t;o>i;o+=r)yield e[o]}function q(e,t=0,n=e.length,r=1){if(r>0)return Eo(e,t,n,r);if(r<0)return jo(e,t,n,r);throw D`can't slice with zero stride`}function*se(...e){for(let t of e)yield*Y(t)}function*Q(e){let t=e[Symbol.iterator](),n=t.next();if(!n.done){let r=n.value,i;for(;!(i=t.next()).done;)yield[r,i.value],r=i.value}}function Fn(e){for(let t of e)return t}function dt(e){return typeof e=="object"&&e!==null&&Symbol.iterator in e&&typeof e[Symbol.iterator]=="function"}function qo(e){if(typeof e!="object"||e===null)return!1;let t="x"in e?e.x:void 0,n="y"in e?e.y:void 0,r="data"in e?e.data:void 0;if(typeof t!="number"&&t!==void 0||typeof n!="number"&&n!==void 0)return!1;let i={x:t,y:n,data:r};return!0}function Ho(e){if(!Array.isArray(e)||e.length!==2)return!1;let t=e,[n,r]=t;return typeof n=="number"&&typeof r=="number"}function Fo(e){if(typeof e!="object"||e===null||!("source"in e)||!("target"in e)||!("points"in e))return!1;let{source:t,target:n,points:r}=e,i="data"in e?e.data:void 0;if(typeof t!="number"||typeof n!="number"||!Array.isArray(r)||!r.every(Ho))return!1;let o={source:t,target:n,points:r,data:i};return!0}function Qt(e){let t=[],n,r=new Map;for(let[a,s]of K(e.nodes()))r.set(s,a),t.push({x:s.ux,y:s.uy,data:s.data}),s===e&&(n=a);let i=[];for(let{source:a,target:s,data:u,points:d}of e.links())i.push({source:r.get(a),target:r.get(s),points:d,data:u});return{nodes:t,links:i,index:n,v:1}}function Zo(e,t,n,r,i){let o=ue(),a=e.map(({x:s,y:u,data:d})=>{let l=o.node(r(d));return l.ux=s,l.uy=u,l});for(let{source:s,target:u,points:d,data:l}of t){let f=o.link(a[s],a[u],i(l));f.points=d.map(([p,m])=>[p,m])}return n===void 0?o:a[n]}function Jt(e){function t(i){if(typeof i!="object"||i===null)throw D`parsedJson was null or wasn't an object: ${i}`;if(!("nodes"in i)||!("links"in i))throw D`parsedJson didn't have 'nodes' and 'links' properties: ${i}`;let{nodes:o,links:a}=i,s="index"in i?i.index:void 0;if(!Array.isArray(o)||!Array.isArray(a))throw D`'nodes' and 'links' weren't arrays: ${i}`;if(!o.every(qo)||!a.every(Fo)||s!==void 0&&typeof s!="number")throw D`'nodes' and 'links' didn't have the appropriate structure: ${i}`;return Zo(o,a,s,e.nodeDatum,e.linkDatum)}function n(i){if(i===void 0)return e.nodeDatum;{let o=e,{nodeDatum:a}=o,s=V(o,["nodeDatum"]);return Jt(T({nodeDatum:i},s))}}t.nodeDatum=n;function r(i){if(i===void 0)return e.linkDatum;{let o=e,{linkDatum:a}=o,s=V(o,["linkDatum"]);return Jt(T({linkDatum:i},s))}}return t.linkDatum=r,t}function Jo(...e){if(e.length)throw D`got arguments to graphJson(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`graphJson()(...)\``;return Jt({nodeDatum:t=>t,linkDatum:t=>t})}var Kt=class{constructor(t,n,r,i="inactive"){this.node=t;this.indeg=n;this.outdeg=r;this.stat=i}bucket(){let t=this.indeg===0?-1/0:this.outdeg===0?1/0:this.indeg-this.outdeg;return this.stat==="top"?Math.min(t,0):this.stat==="bottom"?Math.max(t,0):t}isTop(){return this.indeg<=this.outdeg&&this.stat!=="bottom"||this.stat==="top"}};function Zn(e,t){let n=e[t];if(n===void 0){let r=new Set;return e[t]=r,r}else return n}function Jn(e){var n;let t;for(;e.length&&!((n=t=e[e.length-1])!=null&&n.size);)e.pop();return t||void 0}function Yn(e,t=()=>{}){let n=new Map,r=new Map,i=new Set,o=new Set,a=[],s=[];function u(N){return N===-1/0?i:N===1/0?o:N<=0?Zn(a,-N):Zn(s,N-1)}for(let N of e){let v=N.nparentLinks(),L=N.nchildLinks(),k=new Kt(N,v,L),w=t(N);n.set(N,k),w===void 0?(k.stat="active",u(k.bucket()).add(k)):ut(r,w,k)}let d=[...r].sort(([N],[v])=>N-v).map(([,N])=>N),l=0,f=d.length,p=d.length?d[l++]:new Set,m=d.length>1?d[--f]:new Set;for(let N of p)N.stat="top",u(N.bucket()).add(N);for(let N of m)N.stat="bottom",u(N.bucket()).add(N);function g(){var k;let N;if(N=(k=je(i))!=null?k:je(o))return N;let v=Jn(a),L=Jn(s);if(L)return je(a.length>s.length?v:L);if(v)return je(v)}let c=Array(n.size),b=0,y=n.size,h;for(;h=g();){let{node:N}=h,v=h.isTop()?b++:--y;h.stat="ranked",c[v]=N;for(let[L,k]of N.parentCounts()){let w=n.get(L);u(w.bucket()).delete(w),w.outdeg-=k,w.stat!=="ranked"&&w.stat!=="inactive"&&u(w.bucket()).add(w)}for(let[L,k]of N.childCounts()){let w=n.get(L);u(w.bucket()).delete(w),w.indeg-=k,w.stat!=="ranked"&&w.stat!=="inactive"&&u(w.bucket()).add(w)}if(p.delete(h),!p.size&&l<f){p=d[l++];for(let L of p)L.stat="top",u(L.bucket()).add(L)}if(m.delete(h),!m.size&&l<f){m=d[--f];for(let L of m)L.stat="bottom",u(L.bucket()).add(L)}}return c}function Qn(e,t){let n=new Set,r=new Set,i=[],o;for(let a of e)if(!r.has(a)){for(i.push(a);o=i.pop();)n.delete(o),!r.has(o)&&(r.add(o),i.push(...t(o)));n.add(a)}return n}function Qo(e){let t=new Map(A(e,i=>[i,i.nparents()])),n=[...A(be(t,([,i])=>i===0),([i])=>i)];for(let i of n)t.delete(i);let r;for(;r=n.pop();)for(let i of r.children()){let o=t.get(i)-1;o?t.set(i,o):(t.delete(i),n.push(i))}return!t.size}var Be,Ve,$e,ce,He,Fe,ft,ct,pt,Yt=class{constructor(){F(this,Be,0);F(this,Ve,0);F(this,$e,0);F(this,ce,!0);F(this,He,new Set);F(this,Fe,new Set);F(this,ft,()=>{P(this,Be,C(this,Be)-1)});F(this,ct,(t,n)=>{P(this,Ve,C(this,Ve)+1),t?P(this,$e,C(this,$e)+1):!n&&C(this,ce)===!0&&P(this,ce,null)});F(this,pt,t=>{P(this,Ve,C(this,Ve)-1),t?P(this,$e,C(this,$e)-1):C(this,ce)===!1&&P(this,ce,null)})}*nodes(){for(let t of this.split())yield*Y(t.nodes())}topological(t){return Yn(this.nodes(),t)}*links(){for(let t of this.nodes())yield*Y(t.childLinks())}nnodes(){return C(this,Be)}nlinks(){return C(this,Ve)}*roots(){for(let t of this.split())yield*Y(t.roots())}*leaves(){for(let t of this.split())yield*Y(t.leaves())}*split(){yield*Y(C(this,He));let t;for(;t=En(C(this,Fe));)yield t,t.nnodes()}connected(){let t=!1;for(let n of this.split()){if(t)return!1;t=!0}return!0}multi(){return!!C(this,$e)}acyclic(){if(C(this,ce)===null){for(let t of this.split())if(!t.acyclic())return P(this,ce,!1),!1;return P(this,ce,!0),!0}else return C(this,ce)}node(t){return P(this,Be,C(this,Be)+1),new lt(this,C(this,He),C(this,Fe),C(this,ft),C(this,ct),C(this,pt),t)}link(t,n,r){return t.link(t,n,r)}toJSON(){return Qt(this)}};Be=new WeakMap,Ve=new WeakMap,$e=new WeakMap,ce=new WeakMap,He=new WeakMap,Fe=new WeakMap,ft=new WeakMap,ct=new WeakMap,pt=new WeakMap;function Kn(e){for(let t of e.values())for(let n of t)return n}function ze(e){return e instanceof lt}var re,Ze,Je,Qe,xe,we,Ie,Pe,de,_e,le,ie,X,Ce,qe,he,Le,ht,lt=class{constructor(t,n,r,i,o,a,s){this.data=s;F(this,Ce);F(this,he);F(this,re,void 0);F(this,Ze,void 0);F(this,Je,void 0);F(this,Qe,void 0);F(this,xe,void 0);F(this,we,void 0);F(this,Ie,0);F(this,Pe,0);F(this,de,new Map);F(this,_e,0);F(this,le,new Map);F(this,ie,void 0);F(this,X,void 0);F(this,ht,t=>{var o,a;let{source:n,target:r}=t,i=n.nchildLinksTo(r)>1;if(i){P(n,Ie,C(n,Ie)-1);let s=ae(o=n,he,Le).call(o);s.nlinks-=1,s.multis-=1}else{let s=ae(a=n,Ce,qe).call(a);P(s,X,null),C(this,xe).delete(s),C(this,we).add(n),P(n,ie,n),P(n,X,null),C(this,we).add(r),P(r,ie,r),P(r,X,null)}C(this,Qe).call(this,i),Ut(C(n,le),r,t),P(n,_e,C(n,_e)-1),Ut(C(r,de),n,t),P(r,Pe,C(r,Pe)-1)});P(this,re,t),P(this,xe,n),P(this,we,r),P(this,Ze,i),P(this,Je,o),P(this,Qe,a),P(this,ie,this),P(this,X,{nnodes:1,nlinks:0,multis:0,acyclic:!0,roots:[this],leaves:[this]}),C(this,xe).add(this)}get x(){if(this.ux===void 0)throw D`can't get \`x\` when \`ux\` is undefined`;return this.ux}set x(t){this.ux=t}get y(){if(this.uy===void 0)throw D`can't get \`y\` when \`uy\` is undefined`;return this.uy}set y(t){this.uy=t}*nodes(){yield*Y(Oe(t=>se(t.children(),t.parents()),this))}topological(t){return Yn(this.nodes(),t)}*links(){for(let t of this.nodes())yield*Y(t.childLinks())}nnodes(){return ae(this,he,Le).call(this).nnodes}nlinks(){return ae(this,he,Le).call(this).nlinks}*split(){yield this}connected(){return!0}multi(){return ae(this,he,Le).call(this).multis>0}acyclic(){let t=ae(this,he,Le).call(this);return t.acyclic===null?t.acyclic=Qo(this.nodes()):t.acyclic}node(t){if(C(this,re))return C(this,re).node(t);throw D`can't add a node from a deleted node`}link(t,n,r){var i,o;if(C(this,re)){if(t===n)throw D`tried to create a link between the same node, but self loops are not supported`;if(ze(t)&&ze(n)&&C(t,re)===C(n,re)&&C(this,re)===C(t,re)){let a=new Xt(C(this,re),t,n,C(this,ht),r),s=t.nchildLinksTo(n)>0,u=ae(i=t,Ce,qe).call(i),d=C(u,X),l=ae(o=n,Ce,qe).call(o),f=C(l,X);if(s&&d)P(t,Ie,C(t,Ie)+1),d.nlinks+=1,d.multis+=1;else if(s)P(t,Ie,C(t,Ie)+1);else if(u===l&&d)d.nlinks+=1,d.acyclic===!0&&(d.acyclic=null);else if(u!==l&&d&&f){let[p,m,g,c]=d.nnodes>f.nnodes?[u,d,l,f]:[l,f,u,d];C(this,xe).delete(g),P(g,ie,p),P(g,X,void 0),m.nnodes+=c.nnodes,m.nlinks+=c.nlinks+1,m.multis+=c.multis,m.acyclic=m.acyclic===!1||c.acyclic===!1?!1:m.acyclic===!0&&c.acyclic===!0?!0:null,m.roots=null,m.leaves=null}else u!==l&&(P(u,X,null),P(l,X,null));return C(this,Je).call(this,s,u!==l),P(t,_e,C(t,_e)+1),ut(C(t,le),n,a),P(n,Pe,C(n,Pe)+1),ut(C(n,de),t,a),a}else throw D`when creating a link, both source and target must be current members of the same graph, and can't have been deleted`}else throw D`can't add a link from a deleted node`}nparents(){return C(this,de).size}nchildren(){return C(this,le).size}nparentLinks(){return C(this,Pe)}nchildLinks(){return C(this,_e)}nparentLinksTo(t){var n,r;return ze(t)&&(r=(n=C(this,de).get(t))==null?void 0:n.size)!=null?r:0}*parentLinksTo(t){if(ze(t)){let n=C(this,de).get(t);n&&(yield*Y(n))}}nchildLinksTo(t){var n,r;return ze(t)&&(r=(n=C(this,le).get(t))==null?void 0:n.size)!=null?r:0}*childLinksTo(t){if(ze(t)){let n=C(this,le).get(t);n&&(yield*Y(n))}}*parents(){yield*Y(C(this,de).keys())}*children(){yield*Y(C(this,le).keys())}*parentCounts(){for(let[t,n]of C(this,de))yield[t,n.size]}*childCounts(){for(let[t,n]of C(this,le))yield[t,n.size]}*parentLinks(){for(let t of C(this,de).values())yield*Y(t)}*childLinks(){for(let t of C(this,le).values())yield*Y(t)}*ancestors(){yield*Y(Oe(t=>t.parents(),this))}*descendants(){yield*Y(Oe(t=>t.children(),this))}*roots(){let t=ae(this,he,Le).call(this);t.roots||(t.roots=[...Qn(this.nodes(),n=>n.children())]),yield*Y(t.roots)}*leaves(){let t=ae(this,he,Le).call(this);t.leaves||(t.leaves=[...Qn(this.nodes(),n=>n.parents())]),yield*Y(t.leaves)}parent(t,n){return this.link(t,this,n)}child(t,n){return this.link(this,t,n)}delete(){if(C(this,re)){let t;for(;t=Kn(C(this,le));)t.delete();for(;t=Kn(C(this,de));)t.delete();C(this,xe).delete(this),C(this,we).delete(this),C(this,Ze).call(this),P(this,re,null),P(this,X,null)}}toJSON(){return Qt(this)}};re=new WeakMap,Ze=new WeakMap,Je=new WeakMap,Qe=new WeakMap,xe=new WeakMap,we=new WeakMap,Ie=new WeakMap,Pe=new WeakMap,de=new WeakMap,_e=new WeakMap,le=new WeakMap,ie=new WeakMap,X=new WeakMap,Ce=new WeakSet,qe=function(){let t=this;for(;C(t,ie)!==t;)P(t,ie,C(C(t,ie),ie)),t=C(t,ie);return t},he=new WeakSet,Le=function(){let t=ae(this,Ce,qe).call(this);if(C(t,X)===void 0)throw te`undefined cached info`;if(C(t,X)!==null)return C(t,X);{let n=0,r=0,i=0;for(let o of this.nodes())n+=1,r+=o.nchildLinks(),i+=C(o,Ie),P(o,ie,this),P(o,X,void 0),C(this,we).delete(o);return C(this,xe).add(this),P(this,X,{nnodes:n,nlinks:r,multis:i,acyclic:null,roots:null,leaves:null})}},ht=new WeakMap;var We,Ke,Xt=class{constructor(t,n,r,i,o){this.source=n;this.target=r;this.data=o;F(this,We,void 0);F(this,Ke,void 0);this.points=[];P(this,We,t),P(this,Ke,i)}delete(){C(this,We)&&(C(this,Ke).call(this,this),P(this,We,null))}};We=new WeakMap,Ke=new WeakMap;function ue(){return new Yt}function Ye(e){if(typeof e!="string")throw D`id is supposed to be type string but got type ${typeof e}`;return e}function Xe(e){function t(a){let s=ue(),u=new Map;for(let[d,l]of a.entries()){let f=Ye(e.sourceId(l,d)),p=u.get(f);p===void 0&&(p=s.node(e.nodeDatum(f,d)),u.set(f,p));let m=Ye(e.targetId(l,d)),g=u.get(m);g===void 0&&(g=s.node(e.nodeDatum(m,d)),u.set(m,g)),(f!==m||!e.single)&&s.link(p,g,l)}return s}function n(a){if(a===void 0)return e.sourceId;{let s=e,{sourceId:u}=s,d=V(s,["sourceId"]);return Xe(R(T({},d),{sourceId:a}))}}t.sourceId=n;function r(a){if(a===void 0)return e.targetId;{let s=e,{targetId:u}=s,d=V(s,["targetId"]);return Xe(R(T({},d),{targetId:a}))}}t.targetId=r;function i(a){if(a===void 0)return e.nodeDatum;{let s=e,{nodeDatum:u}=s,d=V(s,["nodeDatum"]);return Xe(R(T({},d),{nodeDatum:a}))}}t.nodeDatum=i;function o(a){return a===void 0?e.single:Xe(R(T({},e),{single:a}))}return t.single=o,t}function Ko(e){if(typeof e!="object"||e===null||!(0 in e))throw D`default source id expected datum[0] to exist but got datum: ${e}; you should check the data you're passing to \`graphConnect()\` to make sure it looks like \`[[source_id, target_id], ...]\` or set a custom accessor with \`graphConnect().source(d => ...).target(d => ...)\``;let t=e[0];if(typeof t=="string")return t;throw D`default source id expected datum[0] to be a string but got datum: ${e}; you should check the data you're passing to \`graphConnect()\` to make sure it looks like \`[[source_id, target_id], ...]\` or set a custom accessor with \`graphConnect().source(d => ...).target(d => ...)\``}function Yo(e){if(typeof e!="object"||e===null||!(1 in e))throw D`default target id expected datum[1] to exist but got datum: ${e}; you should check the data you're passing to \`graphConnect()\` to make sure it looks like \`[[source_id, target_id], ...]\` or set a custom accessor with \`graphConnect().source(d => ...).target(d => ...)\``;let t=e[1];if(typeof t=="string")return t;throw D`default target id expected datum[1] to be a string but got datum: ${e}; you should check the data you're passing to \`graphConnect()\` to make sure it looks like \`[[source_id, target_id], ...]\` or set a custom accessor with \`graphConnect().source(d => ...).target(d => ...)\``}function Xo(e){return e}function ei(...e){if(e.length)throw D`got arguments to graphConnect(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`graphConnect()(...)\``;return Xe({sourceId:Ko,targetId:Yo,nodeDatum:Xo,single:!1})}function en(e,t){function n(...o){var f,p;let a=ue(),s=new Map,u=[],d=0;for(let m of o)if(!s.has(m)){let g=a.node(m);s.set(m,g);for(let[c,b]of(f=t(m,d++))!=null?f:[])u.push([g,c,b])}let l;for(;l=u.pop();){let[m,g,c]=l,b=s.get(g);if(b)a.link(m,b,c);else{let y=a.node(g);s.set(g,y),a.link(m,y,c);let h=(p=t(g,d++))!=null?p:[];for(let[N,v]of h)u.push([y,N,v])}}return a}function r(o){return o===void 0?e:en(o,er(o))}n.children=r;function i(o){return o===void 0?t:en(ti(o),o)}return n.childrenData=i,n}function er(e){function t(n,r){var i;return A((i=e(n,r))!=null?i:[],o=>[o,void 0])}return t.wrapped=e,t}function ti(e){function t(n,r){var i;return A((i=e(n,r))!=null?i:[],([o])=>o)}return t.wrapped=e,t}function ni(e){if(typeof e!="object"||e===null)return!1;if("children"in e){let{children:t}=e;return t===void 0||dt(t)}else return!0}function Xn(e){if(ni(e))return e.children;throw D`datum did not have an iterable children field, and no custom children accessor was specified; try calling \`graphHierarchy().children(d => ...)\` to set a custom children accessor`}function ri(...e){if(e.length)throw D`got arguments to graphHierarchy(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`graphHierarchy()(...)\``;return en(Xn,er(Xn))}function mt(e){function t(o){var d;let a=ue(),s=new Map,u=[];for(let[l,f]of o.entries()){let p=Ye(e.id(f,l)),m=a.node(f),g=(d=e.parentData(f,l))!=null?d:[];for(let[c,b]of g)u.push([c,m,b]);if(s.has(p))throw D`found a duplicate id: ${n}, but ids passed to \`graphStratify()\` must be unique`;s.set(p,m)}for(let[l,f,p]of u){let m=s.get(l);if(!m)throw D`missing id: ${l}; this id was references in a node's parentIds, but no node with that id exists`;a.link(m,f,p)}return a}function n(o){if(o===void 0)return e.id;{let a=e,{id:s}=a,u=V(a,["id"]);return mt(R(T({},u),{id:o}))}}t.id=n;function r(o){if(o===void 0)return e.parentData;{let a=e,{parentIds:s,parentData:u}=a,d=V(a,["parentIds","parentData"]);return mt(R(T({},d),{parentIds:oi(o),parentData:o}))}}t.parentData=r;function i(o){if(o===void 0)return e.parentIds;{let a=e,{parentIds:s,parentData:u}=a,d=V(a,["parentIds","parentData"]);return mt(R(T({},d),{parentIds:o,parentData:nr(o)}))}}return t.parentIds=i,t}function nr(e){function t(n,r){var i;return A((i=e(n,r))!=null?i:[],o=>[o,void 0])}return t.wrapped=e,t}function oi(e){function t(n,r){var i;return A((i=e(n,r))!=null?i:[],([o])=>o)}return t.wrapped=e,t}function ii(e){if(typeof e!="object"||e===null||!("id"in e))throw D`datum did not have an id field, and no id accessor was specified; try calling \`graphStratify().id(d => d...)\` to set a custom id accessor`;let{id:t}=e;if(typeof t=="string")return t;throw D`datum has an id field that was not a string, and no id accessor was specified; try calling \`graphStratify().id(d => d...)\` to set a custom id accessor`}function tr(e){if(typeof e!="object"||e===null)throw D`default parentIds function expected datum to be an object but got: ${e}; try setting a custom accessor for parentIds with \`graphStratify().parentIds(d => ...)\``;if(!("parentIds"in e))return;let{parentIds:t}=e;if(t===void 0||dt(t)&&Hn(t,n=>typeof n=="string"))return t;throw D`default parentIds function expected parentIds to be an iterable of strings but got: ${t}; try setting a custom accessor for parentIds with \`graphStratify().parentIds(d => ...)\``}function ai(...e){if(e.length)throw D`got arguments to graphStratify(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`graphStratify()(...)\``;return mt({id:ii,parentIds:tr,parentData:nr(tr)})}function De(e,t){return e==null||t==null?NaN:e<t?-1:e>t?1:e>=t?0:NaN}function*rr(e,t){if(t===void 0)for(let n of e)n!=null&&(n=+n)>=n&&(yield n);else{let n=-1;for(let r of e)(r=t(r,++n,e))!=null&&(r=+r)>=r&&(yield r)}}function or(e=De){if(e===De)return tn;if(typeof e!="function")throw new TypeError("compare is not a function");return(t,n)=>{let r=e(t,n);return r||r===0?r:(e(n,n)===0)-(e(t,t)===0)}}function tn(e,t){return(e==null||!(e>=e))-(t==null||!(t>=t))||(e<t?-1:e>t?1:0)}function gt(e,t){let n;if(t===void 0)for(let r of e)r!=null&&(n<r||n===void 0&&r>=r)&&(n=r);else{let r=-1;for(let i of e)(i=t(i,++r,e))!=null&&(n<i||n===void 0&&i>=i)&&(n=i)}return n}function yt(e,t){let n;if(t===void 0)for(let r of e)r!=null&&(n>r||n===void 0&&r>=r)&&(n=r);else{let r=-1;for(let i of e)(i=t(i,++r,e))!=null&&(n>i||n===void 0&&i>=i)&&(n=i)}return n}function Nt(e,t,n=0,r=1/0,i){if(t=Math.floor(t),n=Math.floor(Math.max(0,n)),r=Math.floor(Math.min(e.length-1,r)),!(n<=t&&t<=r))return e;for(i=i===void 0?tn:or(i);r>n;){if(r-n>600){let u=r-n+1,d=t-n+1,l=Math.log(u),f=.5*Math.exp(2*l/3),p=.5*Math.sqrt(l*f*(u-f)/u)*(d-u/2<0?-1:1),m=Math.max(n,Math.floor(t-d*f/u+p)),g=Math.min(r,Math.floor(t+(u-d)*f/u+p));Nt(e,t,m,g,i)}let o=e[t],a=n,s=r;for(et(e,n,t),i(e[r],o)>0&&et(e,n,r);a<s;){for(et(e,a,s),++a,--s;i(e[a],o)<0;)++a;for(;i(e[s],o)>0;)--s}i(e[n],o)===0?et(e,n,s):(++s,et(e,s,r)),s<=t&&(n=s+1),t<=s&&(r=s-1)}return e}function et(e,t,n){let r=e[t];e[t]=e[n],e[n]=r}function nn(e,t,n){if(e=Float64Array.from(rr(e,n)),!(!(r=e.length)||isNaN(t=+t))){if(t<=0||r<2)return yt(e);if(t>=1)return gt(e);var r,i=(r-1)*t,o=Math.floor(i),a=gt(Nt(e,o).subarray(0,o+1)),s=yt(e.subarray(o+1));return a+(s-a)*(i-o)}}function Se(e,t){return nn(e,.5,t)}function tt(e,t=De){let n,r=!1;if(t.length===1){let i;for(let o of e){let a=t(o);(r?De(a,i)<0:De(a,a)===0)&&(n=o,i=a,r=!0)}}else for(let i of e)(r?t(i,n)<0:t(i,i)===0)&&(n=i,r=!0);return n}function me(e){return new Set(be(se(e.children(),e.parents()),t=>t.y>e.y))}function ir(e,t){for(let i of e){if(i.ux===void 0)throw oe`lane ${t} didn't assign an x to every node`;if(i.x<0)throw oe`lane ${t} assigned an x less than 0: ${i.x}`}let n=new Set(e.map(i=>i.x));if(!Un(n,new Set(A(n,(i,o)=>o)))){let i=[...n].sort((o,a)=>o-a).join(", ");throw oe`lane ${t} didn't assign increasing positive integers for x coordinates: ${i}`}let r=new Map;for(let[i,o]of e.entries()){let a=r.get(o);if(a!==void 0){for(let s of q(e,a+1,i))if(s.x===o.x)throw oe`lane ${t} assigned nodes to an overlapping lane: ${o.x}`}for(let s of o.children())r.has(s)||r.set(s,i)}return n.size}var rn=class{constructor(t){this.uncompressed=t;this.indices=[]}getIndex(t,n){var a;let r=[];for(let[s,u]of this.indices.entries())u<=t&&r.push(s);this.uncompressed&&r.push(this.indices.length);let i=n===void 0?0:n,o=(a=tt(r,s=>[Math.abs(i-s),s]))!=null?a:this.indices.length;return this.setIndex(o,t),o}setIndex(t,n){this.indices[t]=n}offset(){return 0}},on=class{constructor(t){this.uncompressed=t;this.posIndices=[0];this.negIndices=[]}nextNeg(){return-this.negIndices.length-1}nextPos(){return this.posIndices.length}getIndex(t,n){var s;let r=[];for(let[u,d]of this.negIndices.entries())d<=t&&r.push(-u-1);for(let[u,d]of this.posIndices.entries())d<=t&&r.push(u);this.uncompressed&&(r.push(this.nextNeg()),r.push(this.nextPos()));let i=n===void 0?0:n,o=this.negIndices.length<this.posIndices.length-1?this.nextNeg():this.nextPos(),a=(s=tt(r,u=>[Math.abs(i-u),Math.abs(u),-u]))!=null?s:o;return this.setIndex(a,t),a}setIndex(t,n){t<0?this.negIndices[-t-1]=n:this.posIndices[t]=n}offset(){return this.negIndices.length}};function si(e,t){return t?new on(!e):new rn(!e)}function ui(e,t){for(let r of e){r.ux===void 0&&(r.x=t.getIndex(r.y));for(let i of[...me(r)].sort((o,a)=>a.y-o.y))i.ux===void 0&&(i.x=t.getIndex(r.y,r.x),t.setIndex(i.x,i.y))}let n=t.offset();for(let r of e)r.x+=n}function di(e,t){let n=new Map;for(let i of e)for(let o of me(i)){let a=n.get(o);(a===void 0||i.y<a.y)&&n.set(o,i)}for(let i of q(e,e.length-1,-1,-1)){if(i.ux===void 0){let a=Se(A(me(i),s=>s.x));i.x=t.getIndex(e.length-i.y,a)}let o=n.get(i);o!==void 0&&(o.ux===void 0&&(o.x=i.x),t.setIndex(i.x,e.length-o.y))}let r=t.offset();for(let i of e)i.x+=r}function bt(e,t,n){function r(s){for(let d of s)d.ux=void 0;let u=si(t,n);e?ui(s,u):di(s,u)}function i(s){return s===void 0?e:bt(s,t,n)}r.topDown=i;function o(s){return s===void 0?t:bt(e,s,n)}r.compressed=o;function a(s){return s===void 0?n:bt(e,t,s)}return r.bidirectional=a,r.d3dagBuiltin=!0,r}function an(...e){if(e.length)throw D`got arguments to laneGreedy(${e}); you probably forgot to construct laneGreedy before passing to lane: \`grid().lane(laneGreedy())\``;return bt(!0,!0,!1)}function Ae(e,t){function n(u){let d;if(!u.nnodes())d={width:0,height:0};else{let l=u.topological(e.rank);for(let[b,y]of l.entries())y.y=b;e.lane(l);let f=ir(l,e.lane),{xgap:p,ygap:m}=t,g,c;if(typeof e.nodeSize=="function"){let b=Array(f).fill(0);c=-m;for(let y of l){let[h,N]=e.nodeSize(y);if(h<=0||N<=0)throw D`nodeSize must be positive, but got: [${h}, ${N}]`;b[y.x]=Math.max(b[y.x],h),c+=m,y.y=c+N/2,c+=N}g=-p;for(let[y,h]of b.entries())g+=p,b[y]=g+h/2,g+=h;for(let y of l)y.x=b[y.x]}else{let[b,y]=e.nodeSize;for(let h of l)h.x=(h.x+.5)*b+h.x*p,h.y=(h.y+.5)*y+h.y*m;g=f*(b+p)-p,c=l.length*(y+m)-m}for(let b of u.links()){let{source:y,target:h,points:N}=b;N.splice(0),y.x===h.x?N.push([y.x,y.y],[h.x,h.y]):(N.push([y.x,y.y]),y.y<h.y?N.push([h.x,y.y]):N.push([y.x,h.y]),N.push([h.x,h.y]))}d={width:g,height:c}}for(let l of e.tweaks)d=l(u,d);return d}function r(u){if(u===void 0)return e.lane;{let d=e,{lane:l}=d,f=V(d,["lane"]);return Ae(R(T({},f),{lane:u}),t)}}n.lane=r;function i(u){if(u===void 0)return e.rank;{let d=e,{rank:l}=d,f=V(d,["rank"]);return Ae(R(T({},f),{rank:u}),t)}}n.rank=i;function o(u){if(u===void 0)return e.tweaks;{let d=e,{tweaks:l}=d,f=V(d,["tweaks"]);return Ae(R(T({},f),{tweaks:u}),t)}}n.tweaks=o;function a(u){if(u===void 0)return e.nodeSize;if(typeof u!="function"&&(u[0]<=0||u[1]<=0)){let[l,f]=u;throw D`constant nodeSize must be positive, but got: [${l}, ${f}]`}else{let d=e,{nodeSize:l}=d,f=V(d,["nodeSize"]);return Ae(R(T({},f),{nodeSize:u}),t)}}n.nodeSize=a;function s(u){if(u!==void 0){let[d,l]=u;if(d<0||l<0)throw D`gaps must be non-negative, but got [${d}, ${l}]`;return Ae(e,{xgap:d,ygap:l})}else{let{xgap:d,ygap:l}=t;return[d,l]}}return n.gap=s,n}function li(...e){if(e.length)throw D`got arguments to grid(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`grid()(...)\``;return Ae({lane:an(),rank:()=>{},nodeSize:[1,1],tweaks:[]},{xgap:1,ygap:1})}var qr=An(jr());function fe(e,t,n,r,i={}){let s=qr.Solve.call({},{optimize:e,opType:t,constraints:r,variables:n,ints:i}),{feasible:o}=s,a=V(s,["feasible"]);if(!o)throw te`could not find a feasible simplex solution`;return a}function Si(e){let t=[],n=new Set;for(let r of e){if(!n.has(r)){let i=t.findIndex(a=>a<=r.y),o=i===-1?t.length:i;t[o]=r.y}for(let i of[...me(r)].sort((o,a)=>a.y-o.y))if(!n.has(i)){let o=t.findIndex(s=>s<=r.y),a=o===-1?t.length:o;t[a]=i.y,n.add(i)}}return t.length}function Ct(e){function t(o){var c,b,y;let a={},s={},u={},d=new Map(A(o,(h,N)=>[h,N])),l=e.compressed?Si(o):Math.max(o.length-1,1);for(let h of o.keys())a[h]={opt:0,[h]:1},s[h]={max:l-1};let f=new Map;for(let[h,N]of o.entries()){let v=f.get(N);if(v!==void 0)for(let[L,k]of o.slice(v+1,h).entries()){let w=L+v+1,S=`${h}-${w}-above`;a[S]={opt:0,[S]:1},s[S]={max:1},u[S]=1;let O=`${S}-span`;a[h][O]=1,a[w][O]=-1,a[S][O]=-l,s[O]={min:1-l,max:-1};for(let I of me(k)){if(I===N)continue;let z=d.get(I),M=`${S}-${z}-cross`;a[M]={opt:1,[M]:1},s[M]={max:1},u[M]=1;let $=`${M}-left`;a[h][$]=-1,a[z][$]=1,a[S][$]=l,a[M][$]=-l,s[$]={max:l};let _=`${M}-right`;a[h][_]=-1,a[z][_]=1,a[S][_]=l,a[M][_]=l,s[_]={min:0}}}for(let L of me(N))f.has(L)||f.set(L,h)}if(e.dist){let h=o.reduce((N,v)=>N+me(v).size,0);for(let[N,v]of o.entries())for(let L of me(v)){let k=d.get(L),w=`${N}-${k}-dist`;a[w]={opt:1/h};let S=`${w}-upper`;a[N][S]=1,a[k][S]=-1,a[w][S]=-l,s[S]={max:0};let O=`${w}-lower`;a[N][O]=1,a[k][O]=-1,a[w][O]=l,s[O]={min:0}}}let p=Object.keys(a).length,m=Object.keys(s).length;if(e.check!=="oom"&&p>2e3)throw D`size of dag to decrossOpt is too large and will likely crash instead of complete; you probably want to use a cheaper decrossing strategy for sugiyama like \`sugiyama().decross(decrossTwoLayer())\`, but if you still want to continue you can suppress this check with \`sugiyama().decross(decrossOp().check("oom"))\``;if(e.check==="fast"&&(p>1e3||m>5e3))throw D`size of dag to decrossOpt is too large and will likely not complete; you probably want to use a cheaper decrossing strategy for sugiyama like \`sugiyama().decross(decrossTwoLayer())\`, but if you still want to continue you can suppress this check with \`sugiyama().decross(decrossOp().check("slow"))\``;let g=fe("opt","min",a,s,u);if(e.compressed)for(let[h,N]of o.entries())N.x=(c=g[h])!=null?c:0;else{let h=new Set;for(let v of o.keys())h.add((b=g[v])!=null?b:0);let N=new Map(A([...h].sort(),(v,L)=>[v,L]));for(let[v,L]of o.entries())L.x=N.get((y=g[v])!=null?y:0)}}function n(o){return o===void 0?e.compressed:Ct(R(T({},e),{compressed:o}))}t.compressed=n;function r(o){return o===void 0?e.dist:Ct(R(T({},e),{dist:o}))}t.dist=r;function i(o){return o===void 0?e.check:Ct(R(T({},e),{check:o}))}return t.check=i,t.d3dagBuiltin=!0,t}function Oi(...e){if(e.length)throw D`got arguments to laneOpt(${e}); you probably forgot to construct laneOpt before passing to lane: \`grid().lane(laneOpt())\`, note the trailing "()"`;return Ct({compressed:!1,dist:!0,check:"fast"})}function Tt(e){if(typeof e!="function"){let[t,n]=e;if(t<=0||n<=0)throw D`all node sizes must be positive, but got width ${t} and height ${n}`;return()=>[t,n]}else{let t=new Map;return r=>{let i=t.get(r);if(i===void 0){i=e(r);let[o,a]=i;if(o<=0||a<=0)throw D`all node sizes must be positive, but got width ${o} and height ${a} for node with data: ${r.data}; make sure the callback passed to \`sugiyama().nodeSize(...)\` is doing that`;t.set(r,i)}return i}}}function bn(e){if(typeof e!="function"){let[t,n]=e;return[()=>t,()=>n]}else{let t=e;return[n=>t(n)[0],n=>t(n)[1]]}}var fo=An(so());function kn(e){let t=0,n=0;for(let r of e)n++,t+=(r-t)/n;return n?t:void 0}function $i(e){return Se([...e])}function uo(e){let t=[...e];if(t.sort((n,r)=>n-r),t.length!==0){if(t.length===2)return(t[0]+t[1])/2;if(t.length%2===0){let n=t.length/2,r=t[0],i=t[n-1],o=t[n],a=t[t.length-1],s=i-r,u=a-o;return(i*u+o*s)/(s+u)}else return t[(t.length-1)/2]}}function Pi(e,t){let n=new Map;for(let l of e){let f=t.get(l);f!==void 0&&Re(n,f,l)}let r=[...n.entries()].sort(([l],[f])=>l-f).flatMap(([,l])=>l),i=new Map(e.map((l,f)=>[l,f])),o=e.filter(l=>t.get(l)===void 0),a=new Array(o.length).fill(null);function s(l,f,p,m){if(f<=l)return;let g=Math.floor((l+f)/2),c=o[g],b=i.get(c),y=0,h=[y];for(let v=p;v<m;++v)y+=i.get(r[v])<b?-1:1,h.push(y);let N=p+h.indexOf(Math.min(...h));a[g]=N,s(l,g,p,N),s(g+1,f,N,m)}s(0,o.length,0,r.length),a.push(r.length+1);let u=0,d=0;for(let[l,f]of r.entries()){for(;a[d]==l;)e[u++]=o[d++];e[u++]=f}for(;a[d]==r.length;)e[u++]=o[d++]}function lo({aggregate:e}){function t(r,i,o){let[a,s]=o?[i,r]:[r,i],u=o?f=>f.parents():f=>f.children(),d=new Map(s.map((f,p)=>[f,p])),l=new Map(a.map(f=>{let p=d.get(f),m=p!=null?p:e(A(u(f),g=>d.get(g)));return[f,m]}));Pi(a,l)}function n(r){return r===void 0?e:lo({aggregate:r})}return t.aggregator=n,t.d3dagBuiltin=!0,t}function vn(...e){if(e.length)throw D`got arguments to twolayerAgg(${e}); you probably forgot to construct twolayerAgg before passing to order: \`decrossTwoLayer().order(twolayerAgg())\`, note the trailing "()"`;return lo({aggregate:uo})}function _i(e,t,n,r,i){if(!t.length)return[];let o=[[0]],a=[0],s=[[0]],u=[0];for(let f of e){let p=[0];p.push(...f),o.push(p)}a.push(...t),s.push(...t.map(()=>[0]));for(let f of n)for(let[p,m]of f.entries())s[p+1].push(-m);u.push(...r.map(f=>-f));let{solution:d,message:l}=(0,fo.solveQP)(o,a,s,u,i);if(l.length)throw te`quadratic program failed: ${l}`;return d.shift(),d}function Gt(e,t,n,r,i=0){t.pop(),e.pop(),e.forEach(a=>a.pop()),n.forEach(a=>a.pop());let o=_i(e,t,n,r,i);return o.push(0),o}function co(e){let t=new Map,n=0;for(let r of e)for(let i of r)t.has(i)||t.set(i,n++);return t}function Mt(e,t,n,r=0){let i=1+Math.max(...t.values()),o=Array(i).fill(null).map((d,l)=>Array(i).fill(null).map((f,p)=>l===p?r:0)),a=Array(i).fill(0),s=[],u=[];for(let d of e)for(let[l,f]of Q(d)){let p=t.get(l),m=t.get(f),g=Array(i).fill(0);g[p]=1,g[m]=-1,s.push(g),u.push(-n(l,f))}return[o,a,s,u]}function po(e,t,n,r){e[n][n]+=r,e[n][t]-=r,e[t][n]-=r,e[t][t]+=r}function Rt(e,t,n,r,i,o){let a=i+o;e[r][r]+=o*o,e[r][n]-=o*a,e[r][t]+=o*i,e[n][r]-=a*o,e[n][n]+=a*a,e[n][t]-=a*i,e[t][r]+=i*o,e[t][n]-=i*a,e[t][t]+=i*i}function zt(e,t,n,r){for(let[a,s]of n)a.x=r[s];let i=1/0,o=-1/0;for(let a of e){let s=a[0],u=a[a.length-1];i=Math.min(i,s.x-t(void 0,s)),o=Math.max(o,u.x+t(u,void 0))}for(let a of n.keys())a.x-=i;return o-i}function Ge(e){return kn(Ne(e,t=>A(t.children(),n=>n.y-t.y)))}function ho([e,t,n]){if(e<=0||t<=0||n<=0)throw D`simplex weights must be positive, but got: ${e}, ${t}, ${n}`}function Wi(e,t){if(typeof t!="function"){let[n,r,i]=t;return(o,a)=>{switch(+(o.data.role==="node")+ +(a.data.role==="node")){case 0:return i;case 1:return r;case 2:return n;default:throw te`invalid count`}}}else{let n=new Map;for(let r of Ne(e,i=>i))if(r.data.role==="node"){let i=r.data.node,o=new Map;for(let a of i.childLinks()){let{target:s}=a,u=t(a);ho(u),o.set(s,u)}n.set(i,o)}return(r,i)=>{if(r.data.role==="link"){let{source:o,target:a}=r.data.link,[,s,u]=n.get(o).get(a);return i.data.role==="link"?u:s}else if(i.data.role==="link"){let{source:o,target:a}=i.data.link,[,s]=n.get(o).get(a);return s}else{let[o]=n.get(r.data.node).get(i.data.node);return o}}}}function mo(e){function t(r,i){var b;let o={},a={},s=Wi(r,e.weight),u=new Map,d=0;for(let y of r)for(let h of y)if(!u.has(h)){let N=`${d++}`;u.set(h,N),o[N]={}}function l(y){return u.get(y)}for(let y of r)for(let[h,N]of Q(y)){let v=l(h),L=l(N),k=`layer ${v} -> ${L}`,w=i(h,N);a[k]={min:w},o[v][k]=-1,o[L][k]=1}let f=Ge(u.keys());for(let y of u.keys()){let h=l(y);for(let N of y.children()){let v=l(N),L=`link ${h} -> ${v}`,k=`${L} parent`;a[k]={min:0};let w=`${L} child`;a[w]={min:0},o[h][k]=1,o[h][w]=-1,o[v][k]=-1,o[v][w]=1;let S=s(y,N),O=(N.y-y.y)/f;o[L]={opt:S/O,[k]:1,[w]:1}}}let p=fe("opt","min",o,a);for(let[y,h]of u)y.x=(b=p[h])!=null?b:0;let m=0,g=0;for(let y of r){let h=y[0];m=Math.min(m,h.x-i(void 0,h));let N=y[y.length-1];g=Math.max(g,N.x+i(N,void 0))}for(let y of u.keys())y.x-=m;let c=g-m;if(c<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;return c}function n(r){if(r===void 0)return e.weight;{typeof r!="function"&&ho(r);let i=e,{weight:o}=i,a=V(i,["weight"]);return mo(R(T({},a),{weight:r}))}}return t.weight=n,t.d3dagBuiltin=!0,t}function Ln(...e){if(e.length)throw D`got arguments to coordSimplex(${e}); you probably forgot to construct coordSimplex before passing to coord: \`sugiyama().coord(coordSimplex())\`, note the trailing "()"`;return mo({weight:[1,2,8]})}function go(e,t){let n=new Map,r=new Map(e.map((o,a)=>[o,a]));function i(o,a){var u;let s=(u=n.get(o))==null?void 0:u.get(a);if(s!==void 0)return s;if(r.has(o)||r.has(a))return-1/0;{let d=0;for(let[p,m]of t(o)){let g=r.get(p);for(let[c,b]of t(a)){let y=r.get(c);d+=Math.sign(g-y)*m*b}}let l=n.get(o);l===void 0?n.set(o,new Map([[a,d]])):l.set(a,d);let f=n.get(a);return f===void 0?n.set(a,new Map([[o,-d]])):f.set(o,-d),d}}return i}function Ai(e,t){let n=[[0,e.length]],r;for(;r=n.pop();){let[i,o]=r;if(i>=o)continue;let a=0,s=o;for(let u=i;u<o-1;++u){let d=t(e[u],e[u+1]);d>a&&(a=d,s=u)}if(s!==o){let u=e[s+1];e[s+1]=e[s],e[s]=u,n.push([i,s],[s+2,o])}}}function Ui(e,t){let n=Array(e.length*(e.length-1)/2);for(;;){let r=0;for(let d=1;d<e.length;++d){let l=0,f=r;for(let p=d-1;p>=0;--p)n[f]=l,l+=t(e[p],e[d]),f-=e.length-p-1;r+=e.length-d}let i=0,o=0,a=0,s=0;for(let d=0;d<e.length-1;++d){let l=0;for(let f=d+1;f<e.length;++f){l+=t(e[d],e[f]);let p=n[i++]+l;p>o&&(o=p,a=d,s=f)}}if(o===0)break;let u=e[s];e[s]=e[a],e[a]=u}}function wn({baseOp:e,doScan:t}){function n(o,a,s){e(o,a,s);let u=s?a:o,d=s?go(o,l=>l.parentCounts()):go(a,l=>l.childCounts());t?Ui(u,d):Ai(u,d)}function r(o){return o===void 0?e:wn({baseOp:o,doScan:t})}n.base=r;function i(o){return o===void 0?t:wn({baseOp:e,doScan:o})}return n.scan=i,n.d3dagBuiltin=!0,n}function Dn(...e){if(e.length)throw D`got arguments to twolayerGreedy(${e}); you probably forgot to construct twolayerGreedy before passing to order: \`decrossTwoLayer().order(twolayerGreedy())\`, note the trailing "()"`;return wn({baseOp:()=>{},doScan:!1})}function Sn(e,t){function n(r,i){let o=r?e(r):0,a=i?e(i):0,s=(o+a)/2;return r&&i?s+t:s}return n}function Bt(e){let t=0;for(let[n,r]of Q(e)){let i=new Map(r.map((o,a)=>[o,a]));for(let[o,a]of n.entries())for(let s of n.slice(o+1))for(let[u,d]of a.childCounts())for(let[l,f]of s.childCounts())u!==l&&i.get(u)>i.get(l)&&(t+=d*f)}return t}function yo(e){function t(r){let i;e.topDown?i=Oe(o=>[...o.children()].sort((a,s)=>s.nchildren()-a.nchildren()),...Ne(r,o=>[...be(o,a=>!a.nparents())].sort((a,s)=>s.nchildren()-a.nchildren()))):i=Oe(o=>[...o.parents()].sort((a,s)=>s.nparents()-a.nparents()),...Ne(q(r,r.length-1,-1,-1),o=>[...be(o,a=>!a.nchildren())].sort((a,s)=>s.nparents()-a.nparents())));for(let o of r)o.splice(0);for(let o of i){let{data:a}=o;if(a.role==="node")for(let s=a.topLayer;s<=a.bottomLayer;++s)r[s].push(o);else r[a.layer].push(o)}}function n(r){return r===void 0?e.topDown:yo({topDown:r})}return t.topDown=n,t.d3dagBuiltin=!0,t}function Vt(...e){if(e.length)throw D`got arguments to decrossDfs(${e}); you probably forgot to construct decrossDfs before passing to decross: \`sugiyama().decross(decrossDfs())\`, note the trailing "()"`;return yo({topDown:!0})}function $t(e){function t(o){let a=o.slice().reverse(),s=o.map(l=>l.slice()),u=Bt(s),d=e.inits.length?e.inits:[()=>{}];for(let l of d){l(o);let f=!0;for(let p=0;p<e.passes&&f;++p){f=!1;for(let[c,b]of Q(o)){let y=b.slice();e.order(c,b,!0),b.some((h,N)=>y[N]!==h)&&(f=!0)}let m=Bt(o);m<u&&(u=m,s=o.map(c=>c.slice()));for(let[c,b]of Q(a)){let y=b.slice();e.order(b,c,!1),b.some((h,N)=>y[N]!==h)&&(f=!0)}let g=Bt(o);g<u&&(u=g,s=o.map(c=>c.slice()))}}o.splice(0,o.length,...s)}function n(o){if(o===void 0)return e.order;{let a=e,{order:s}=a,u=V(a,["order"]);return $t(R(T({},u),{order:o}))}}t.order=n;function r(o){if(o===void 0)return[...e.inits];{let a=e,{inits:s}=a,u=V(a,["inits"]);return $t(R(T({},u),{inits:o}))}}t.inits=r;function i(o){if(o===void 0)return e.passes;if(o<=0)throw D`number of passes must be positive`;return $t(R(T({},e),{passes:o}))}return t.passes=i,t.d3dagBuiltin=!0,t}function On(...e){if(e.length)throw D`got arguments to decrossTwoLayer(${e}); you probably forgot to construct decrossTwoLayer before passing to decross: \`sugiyama().decross(decrossTwoLayer())\`, note the trailing "()"`;return $t({order:Dn().base(vn()),inits:[Vt().topDown(!0),Vt().topDown(!1)],passes:24})}function In(e,t){return+!!(e&&t)}function Cn(e){function t(i,o){var y;let a={},s={},u=new Map(A(i.nodes(),(h,N)=>[h,N.toString()]));function d(h){return u.get(h)}function l(h){return a[d(h)]}function f(h,N,v,L,k=0){let w=l(N),S=l(v),O=`${h}: ${d(N)} -> ${d(v)}`;s[O]={min:L},w[O]=-1,S[O]=1,w.opt+=k,S.opt-=k}function p(h,N,v){f(`${h} before`,N,v,0),f(`${h} after`,v,N,0)}let m=[],g=new Map;for(let h of i.nodes()){let N=d(h);a[N]={opt:0};let v=e.rank(h);v!==void 0&&m.push([v,h]);let L=e.group(h);if(L!==void 0){let k=g.get(L);k?k.push(h):g.set(L,[h])}}let c=new Set;for(let h of i.topological(e.rank)){for(let[N,v]of h.childCounts())c.has(N)?f("link",N,h,o(N,h),v):f("link",h,N,o(h,N),v);c.add(h)}let b=m.sort(([h],[N])=>h-N);for(let[[h,N],[v,L]]of Q(b))h<v?f("rank",N,L,o(N,L)):p("rank",N,L);for(let h of g.values())for(let[N,v]of Q(h))p("group",N,v);try{let h=fe("opt","max",a,s,{}),N=0,v=0;for(let L of i.nodes()){let k=(y=h[d(L)])!=null?y:0;L.y=k,N=Math.min(N,k-o(void 0,L)),v=Math.max(v,k+o(L,void 0))}for(let L of i.nodes())L.y-=N;return v-N}catch(h){throw g.size?D`could not find a feasible simplex layout; this is likely due to group constraints producing an infeasible layout, try relaxing the functions you're passing to \`layeringSimplex().group(...)\``:te`could not find a feasible simplex solution`}}function n(i){if(i===void 0)return e.rank;{let o=e,{rank:a}=o,s=V(o,["rank"]);return Cn(R(T({},s),{rank:i}))}}t.rank=n;function r(i){if(i===void 0)return e.group;{let o=e,{group:a}=o,s=V(o,["group"]);return Cn(R(T({},s),{group:i}))}}return t.group=r,t.d3dagBuiltin=!0,t}function No(){}function Tn(...e){if(e.length)throw D`got arguments to layeringSimplex(${e}); you probably forgot to construct layeringSimplex before passing to layering: \`sugiyama().layering(layeringSimplex())\`, note the trailing "()"`;return Cn({rank:No,group:No})}function bo(e,t,n,r){for(let[o,[a,s]]of t){let u=a.bottomLayer;for(let d of o.childLinks()){let[l,f]=t.get(d.target),p=l.topLayer;if(p>u){let m=s;for(let g=u+1;g<p;++g){let c=e.node({link:d,layer:g,role:"link"});m.child(c,void 0),m=c}m.child(f)}else if(p<u){let m=f;for(let g=p+1;g<u;++g){let c=e.node({link:d,layer:g,role:"link"});m.child(c,void 0),m=c}m.child(s)}else throw oe`layering ${r} assigned nodes with an edge to the same layer`}}let i=Array(n).fill(null).map(()=>[]);for(let o of e.nodes()){let{data:a}=o;if(a.role==="node"){let{topLayer:s,bottomLayer:u}=a;for(let d=s;d<=u;++d)i[d].push(o)}else{let{layer:s}=a;i[s].push(o)}}for(let o of i)if(!o.length)throw oe`layering ${r} didn't assign a node to every layer`;return i}function Gn(e,t,n,r,i){let o=ue(),a=Array(r).fill(!1),s=new Map;for(let p of e.nodes()){let m=p.uy;if(m===void 0)throw oe`layering ${i} didn't assign a layer to a node`;if(m<0||m>=r)throw oe`layering ${i} assigned node an invalid layer: ${m}`;{let g=se(p.parentCounts(),p.childCounts());!a[m]&&Zt(g,([{uy:b},y])=>y>1&&b===m-1)&&(a[m]=!0);let c={node:p,topLayer:m,bottomLayer:m,role:"node"};s.set(p,[c,o.node(c)])}}let u=0,d=a.map(p=>u+=+p);for(let[p]of s.values()){let m=d[p.topLayer];p.topLayer+=m,p.bottomLayer+=m}let l=bo(o,s,r+u,i),f=-n;for(let p of l){f+=n;let m=Math.max(-n,...A(p,({data:c})=>c.role==="node"?t(c.node):-1/0)),g=f+m/2;for(let c of p)c.y=g;f+=m}return[l,f]}function Ei(e,t,n,r){let i=ue(),o=[0,n],a=new Map;for(let b of e.nodes()){let y=b.uy;if(y===void 0)throw oe`layering ${r} didn't assign a y coordinate to every node`;{let h=t(b)/2,N=y-h,v=y+h,L={node:b,topLayer:N,bottomLayer:v,role:"node"};a.set(b,[L,i.node(L)]),o.push(N,v)}}o.sort((b,y)=>b-y);let s=n/a.size*.001,u=[],d=new Map,l=0,f=0;for(let b of o)b>l+s&&(u.push(l),l=b,f++),d.set(b,f);u.push(l);let p=Array(u.length).fill(!1);for(let[b,[{topLayer:y}]]of a){let h=d.get(y),N=h-1;for(let[v,L]of se(b.childCounts(),b.parentCounts()))if(L>1){let[{bottomLayer:k}]=a.get(v);if(d.get(k)===N){p[h]||(p[h]=!0,u.push((y+k)/2));break}}}u.sort((b,y)=>b-y);let m=0,g=p.map(b=>m+=+b);for(let[b,y]of d)d.set(b,y+g[y]);for(let[b]of a.values())b.topLayer=d.get(b.topLayer),b.bottomLayer=d.get(b.bottomLayer);let c=bo(i,a,u.length,r);for(let b of c)for(let y of b)y.data.role==="node"?y.y=y.data.node.y:y.y=u[y.data.layer];return c}function Mn(e){for(let t of e)for(let n of t)if(n.data.role==="node"){let{node:r}=n.data;r.x=n.x,r.y=n.y;for(let i of n.children()){let o=[[n.x,n.y]],a;for(;i.data.role==="link";)a=i.data.link,o.push([i.x,i.y]),[i]=i.children();o.push([i.x,i.y]);let s=i.data.node,u=se(r.childLinksTo(s),r.parentLinksTo(s));a||([a]=u),a.source!==r&&o.reverse(),a.points.splice(0,a.points.length,...o)}}}function Rn(e,t=0){return({data:n})=>n.role==="node"?e(n.node):t}function xo(e,t,n,r,i=.001){for(let o of e){for(let a of o)if(a.ux===void 0)throw oe`coord ${r} didn't assign an x to every node`;for(let[[a,s],[u,d]]of Q(se([[void 0,0]],A(o,l=>[l,l.x]),[[void 0,n]])))if(d-s<t(a,u)-i)throw oe`coord ${r} assigned nodes too close for separation`}}function Me(e,t){function n(d){let l;if(!d.nnodes())l={width:0,height:0};else{let[f,p]=bn(Tt(e.nodeSize)),[m,g]=t.gap,c=e.layering(d,In)+1,[b,y]=Gn(d,p,g,c,e.layering);e.decross(b);let h=Sn(Rn(f),m),N=e.coord(b,h);xo(b,h,N,e.coord),Mn(b),l={width:N,height:y}}for(let f of e.tweaks)l=f(d,l);return l}function r(d){if(d===void 0)return e.layering;{let l=e,{layering:f}=l,p=V(l,["layering"]);return Me(R(T({},p),{layering:d}),t)}}n.layering=r;function i(d){if(d===void 0)return e.decross;{let l=e,{decross:f}=l,p=V(l,["decross"]);return Me(R(T({},p),{decross:d}),t)}}n.decross=i;function o(d){if(d===void 0)return e.coord;{let l=e,{coord:f}=l,p=V(l,["coord"]);return Me(R(T({},p),{coord:d}),t)}}n.coord=o;function a(d){if(d===void 0)return e.tweaks;{let l=e,{tweaks:f}=l,p=V(l,["tweaks"]);return Me(R(T({},p),{tweaks:d}),t)}}n.tweaks=a;function s(d){if(d===void 0)return e.nodeSize;if(typeof d!="function"&&(d[0]<=0||d[1]<=0)){let[f,p]=d;throw D`constant nodeSize must be positive, but got: [${f}, ${p}]`}else{let l=e,{nodeSize:f}=l,p=V(l,["nodeSize"]);return Me(R(T({},p),{nodeSize:d}),t)}}n.nodeSize=s;function u(d){if(d!==void 0){let[l,f]=d;if(l<0||f<0)throw D`gap width (${l}) and height (${f}) must be non-negative`;return Me(e,R(T({},t),{gap:d}))}else{let[l,f]=t.gap;return[l,f]}}return n.gap=u,n}function ji(...e){if(e.length)throw D`got arguments to sugiyama(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`sugiyama()(...)\``;return Me({layering:Tn(),decross:On(),coord:Ln(),nodeSize:[1,1],tweaks:[]},{gap:[1,1]})}function qi(...e){if(e.length)throw D`got arguments to coordCenter(${e}); you probably forgot to construct coordCenter before passing to coord: \`sugiyama().coord(coordCenter())\`, note the trailing "()"`;function t(n,r){let i=n.map(a=>{let s=0,u;for(let d of a)s+=r(u,d),d.x=s,u=d;return s+=r(u,void 0),s}),o=Math.max(...i);if(o<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;for(let[a,s]of n.entries()){let u=i[a],d=(o-u)/2;for(let l of s)l.x+=d}return o}return t.d3dagBuiltin=!0,t}function ko(e,t){for(let n of e){let r=Se([...A(t(n),({x:i})=>i)]);r!==void 0&&(n.x=r)}}function vo(e,t){for(let n of e){let[r]=t(n);n.data.role==="link"&&r.data.role==="link"&&(n.x=r.x)}}function it(e,t){let n=e[e.length-1],r=n.x,i=[r];for(let o of q(e,e.length-2,-1,-1)){let a=Math.min(o.x,r-t(n,o));i.push(a),n=o,r=a}i.reverse(),n=e[0],r=n.x,n.x=(r+i[0])/2;for(let[o,a]of K(q(e,1))){let s=Math.max(a.x,r+t(n,a));a.x=(s+i[o+1])/2,n=a,r=s}}function Hi(e,t){for(let[n,r]of e.entries()){let i=t[n];for(let[o,{x:a}]of r.entries())if(i[o]!==a)return!1}return!0}function Fi(...e){if(e.length)throw D`got arguments to coordGreedy(${e}); you probably forgot to construct coordGreedy before passing to coord: \`sugiyama().coord(coordGreedy())\`, note the trailing "()"`;function t(n,r){let i=0,o=0,a=new Set;for(let l of n)for(let f of l)a.has(f)||(a.add(f),f.ux!==void 0&&(i+=(f.ux-i)/++o));for(let l of n){let f=0,p=0;for(let g of l)g.ux!==void 0&&(f+=(g.ux-f)/++p);let m=p?f:i;for(let g of l)g.ux===void 0&&(g.ux=m);it(l,r)}for(let l of q(n,1))ko(l,f=>f.parents()),it(l,r);for(let l of q(n,n.length-2,-1,-1))ko(l,f=>f.children()),it(l,r);for(let l=0;l<n.length;++l){let f=n.map(p=>p.map(({x:m})=>m));for(let p of q(n,1))vo(p,m=>m.parents()),it(p,r);for(let p of q(n,n.length-2,-1,-1))vo(p,m=>m.children()),it(p,r);if(Hi(n,f))break}let s=1/0,u=-1/0;for(let l of n){let f=l[0];s=Math.min(s,f.x-r(void 0,f));let p=l[l.length-1];u=Math.max(u,p.x+r(p,void 0))}for(let l of a)l.x-=s;let d=u-s;if(d<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;return d}return t.d3dagBuiltin=!0,t}function Zi(e,t){if(typeof e!="function")return()=>e;{let n=new Map;for(let r of Ne(t,i=>i))if(r.data.role==="node"){let i=r.data.node,o=new Map;for(let a of i.childLinks()){let s=e(a);if(s<0)throw D`link weights must be non-negative; double check the accessor passed into \`coordQuad().vertWeak(...)\``;o.set(a.target,s)}n.set(i,o)}return(r,i)=>n.get(r).get(i)}}function zn(e,t,n){if(typeof e!="function")return()=>e;{let r=new Map;return i=>{let o=r.get(i);if(o===void 0){let a=e(i);if(a<0)throw new Error(`${t} weights must be non-negative; double check the accessor passed into \`coordQuad().${n}(...)\``);return r.set(i,a),a}else return o}}}function Ee(e){function t(s,u){let d=co(s),[l,f,p,m]=Mt(s,d,u,e.comp),g=Zi(e.vertWeak,s),c=zn(e.vertStrong,"link","vertStrong"),b=zn(e.linkCurve,"link","linkCurve"),y=zn(e.nodeCurve,"node","nodeCurve"),h=Ge(d.keys());for(let[v,L]of d){let k=v.data,w=k.role==="node"?k.node:k.link.source;for(let S of v.children()){let O=d.get(S),I=S.data,z=I.role==="node"?I.node:I.link.target,M=k.role==="node"?g(w,z):c(k.link),$=I.role==="node"?g(w,z):c(I.link),_=I.role==="node"?y(I.node):b(I.link),W=(S.y-v.y)/h;po(l,L,O,(M+$)/W);for(let B of S.children()){let Z=d.get(B),E=(B.y-S.y)/h;Rt(l,L,O,Z,_/W,_/E)}}}let N;try{let v=Gt(l,f,p,m);N=zt(s,u,d,v)}catch(v){throw typeof v=="string"?te`${v}`:te`undefined quadprog exception`}if(N<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;return N}function n(s){if(s===void 0)return e.vertWeak;if(typeof s=="number"&&s<0)throw D`vertWeak must be non-negative but was: ${s}`;{let u=e,{vertWeak:d}=u,l=V(u,["vertWeak"]);return Ee(R(T({},l),{vertWeak:s}))}}t.vertWeak=n;function r(s){if(s===void 0)return e.vertStrong;if(typeof s=="number"&&s<0)throw D`vertStrong must be non-negative but was: ${s}`;{let u=e,{vertStrong:d}=u,l=V(u,["vertStrong"]);return Ee(R(T({},l),{vertStrong:s}))}}t.vertStrong=r;function i(s){if(s===void 0)return e.linkCurve;if(typeof s=="number"&&s<0)throw D`linkCurve must be non-negative but was: ${s}`;{let u=e,{linkCurve:d}=u,l=V(u,["linkCurve"]);return Ee(R(T({},l),{linkCurve:s}))}}t.linkCurve=i;function o(s){if(s===void 0)return e.nodeCurve;if(typeof s=="number"&&s<0)throw D`nodeCurve must be non-negative but was: ${s}`;{let u=e,{nodeCurve:d}=u,l=V(u,["nodeCurve"]);return Ee(R(T({},l),{nodeCurve:s}))}}t.nodeCurve=o;function a(s){if(s===void 0)return e.comp;if(s<=0)throw D`compress weight must be positive, but was: ${s}`;return Ee(R(T({},e),{comp:s}))}return t.compress=a,t.d3dagBuiltin=!0,t}function Ji(...e){if(e.length)throw D`got arguments to coordQuad(${e}); you probably forgot to construct coordQuad before passing to coord: \`sugiyama().coord(coordQuad())\`, note the trailing "()"`;return Ee({vertWeak:1,vertStrong:0,linkCurve:1,nodeCurve:0,comp:1e-6})}function Lo(e){function t(r,i){for(let o of r)if(o.reduce((s,u)=>s+ +(u.data.role==="node"),0)>1)throw D`topological() only works with a topological layering, make sure you've set up sugiyama as \`sugiyama().layering(layeringTopological())\``;if(e.simp){let o={center:{}},a={},s=new Map,u=0;for(let c of r){let b=!0;for(let y of c)if(y.data.role==="link"){let h=`${u++}`;s.set(y,[h,b]),o[h]={}}else s.set(y,["center",!1]),b=!1}let d=c=>s.get(c);for(let c of r)for(let[b,y]of Q(c)){let[h,N]=d(b),[v,L]=d(y),k=`layer ${h} -> ${v}`,w=i(b,y);a[k]={min:w},o[h][k]=N?1:-1,o[v][k]=L?-1:1}let l=Ge(s.keys());for(let c of r)for(let b of c){let[y,h]=d(b);if(y!=="center")for(let N of b.children()){let[v,L]=d(N);if(v!=="center"){let k=`link ${y} -> ${v}`,w=`${k} parent`;a[w]={min:0};let S=`${k} child`;a[S]={min:0},o[y][w]=h?-1:1,o[y][S]=h?1:-1,o[v][w]=L?1:-1,o[v][S]=L?-1:1;let O=(N.y-b.y)/l;o[k]={opt:1/O,[w]:1,[S]:1}}}}delete o.center;let f=fe("opt","min",o,a);for(let[c,[b,y]]of s){let h=f[b];c.x=h===void 0?0:y?-h:h}let p=0,m=0;for(let c of r){let b=c[0];p=Math.min(p,b.x-i(void 0,b));let y=c[c.length-1];m=Math.max(m,y.x+i(y,void 0))}for(let c of s.keys())c.x-=p;let g=m-p;if(g<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;return g}else{let o=new Map,a=0;for(let g of r)for(let c of g)c.data.role==="link"&&o.set(c,a++);for(let g of r)for(let c of g)c.data.role==="node"&&o.set(c,a);let[s,u,d,l]=Mt(r,o,i),f=Ge(o.keys());for(let g of o.keys()){let c=o.get(g);for(let b of g.children()){let y=o.get(b),h=(b.y-g.y)/f;if(b.data.role==="link")for(let N of b.children()){let v=o.get(N),L=(N.y-b.y)/f;Rt(s,c,y,v,1/h,1/L)}}}let p=Gt(s,u,d,l),m=zt(r,i,o,p);if(m<=0)throw D`must assign nonzero width to at least one node; double check the callback passed to \`sugiyama().nodeSize(...)\``;return m}}function n(r){return r===void 0?e.simp:Lo(R(T({},e),{simp:r}))}return t.straight=n,t.d3dagBuiltin=!0,t}function Qi(...e){if(e.length)throw D`got arguments to coordTopological(${e}); you probably forgot to construct coordTopological before passing to coord: \`sugiyama().coord(coordTopological())\`, note the trailing "()"`;return Lo({simp:!0})}function Ki(e){var s,u;let t=[],n=new Map,r=new Map;for(let d of e){let[l]=d;l!==t[t.length-1]&&t.push(l);for(let f of q(d,1)){let p=(s=r.get(f))!=null?s:0;r.set(f,p+1)}for(let[f,p]of Q(d))Re(n,f,p)}let i=new Map,o=0,a;for(;a=t.pop();){i.set(a,o++);for(let d of(u=n.get(a))!=null?u:[]){let l=r.get(d)-1;r.set(d,l),l||t.push(d)}}return i}function Bn(e){function t(i){var L;let o=i.reduce((k,w)=>k+w.length*Math.max(w.length-1,0)/2,0),a=[];if(e.dist)for(let[k,w]of Q(i)){let S=w.filter(M=>!M.nparents()),O=k.map(M=>[...M.children()]);a.push([S,O]);let I=k.filter(M=>!M.nchildren()),z=w.map(M=>[...M.parents()]);a.push([I,z])}let s=Ki(i),u=new Map;function d(k,w){var O;let S=`${k} => ${w}`;return(O=u.get(S))!=null?O:S}let l=new Map;for(let[k,w]of K(q(i,0,i.length-1)))for(let S of w){if(S.data.role!=="node"||S.data.bottomLayer===k)continue;let O=s.get(S),I=!0;for(let z of w)if(z===S)I=!1;else if(z.data.role!=="node"||z.data.bottomLayer===k){let M=s.get(z),$=I?d(M,O):d(O,M);for(let _ of z.children()){let W=s.get(_),B=I?d(W,O):d(O,W);l.set(B,$)}}}let f=new Map;for(let[k,w]of l){let S=w,O;for(;O=l.get(S);)S=O;let I=f.get(S);I?I.push(k):f.set(S,[S,k])}for(let k of f.values()){let w=`{ ${k.join(" & ")} }`;for(let S of k)u.set(S,w)}let m=1/(a.reduce((k,[w,S])=>S.reduce((O,I)=>O+I.length*I.length,0)*w.length,0)/4+1),g=m/(o+1),c={},b={},y={};for(let k of i){for(let[w,S]of k.entries()){let O=s.get(S);for(let I of q(k,w+1)){let z=s.get(I),M=d(O,z);y[M]=1,b[M]={max:1},c[M]={opt:g,[M]:1}}}for(let[w,S]of k.entries()){let O=s.get(S);for(let[I,z]of K(q(k,w+1))){let M=s.get(z);for(let $ of k.slice(w+I+2)){let _=s.get($),W=d(O,M),B=d(O,_),Z=d(M,_),E=`tri: ${O} - ${M} - ${_}`,j=`${E} +`,U=`${E} -`;b[j]={max:1},c[W][j]=1,c[B][j]=-1,c[Z][j]=1,b[U]={min:0},c[W][U]=1,c[B][U]=-1,c[Z][U]=1}}}}for(let[k,w]of K(q(i,0,i.length-1)))for(let[S,O]of w.entries()){if(O.data.role==="node"&&O.data.bottomLayer!==k)continue;let I=s.get(O);for(let z of q(w,S+1)){if(z.data.role==="node"&&z.data.bottomLayer!==k)continue;let M=s.get(z),$=d(I,M),_=new Map;for(let[W,B]of O.childCounts()){let Z=s.get(W);for(let[E,j]of z.childCounts()){if(W===E)continue;let U=s.get(E),ne=Math.sign(Z-U),ee=ne<0?d(Z,U):d(U,Z),ve=(L=_.get(ee))!=null?L:0;_.set(ee,ne*B*j+ve)}}for(let[W,B]of _){let Z=`slack: ${$} : ${W}`,E=`${Z} +`,j=`${Z} -`;B<0?(c[Z]={opt:-B,[E]:1,[j]:1},b[E]={min:0},c[$][E]=1,c[W][E]=-1,b[j]={min:0},c[$][j]=-1,c[W][j]=1):B>0&&(c[Z]={opt:B,[E]:1,[j]:1},b[E]={min:1},c[$][E]=1,c[W][E]=1,b[j]={min:-1},c[$][j]=-1,c[W][j]=-1)}}}for(let[k,w]of a)for(let S of k){let O=s.get(S);for(let I of w)for(let[z,M]of K(I)){let $=s.get(M);for(let _ of q(I,z+1)){let W=s.get(_),B=`dist: ${$} - ${O} - ${W}`,Z=`${B} :normal`,E=`${B} :reversed`;c[B]={opt:m,[Z]:1,[E]:1};let j=0;for(let[U,ne]of[[$,O],[$,W],[O,W]]){let ee=Math.sign(U-ne),ve=ee<0?d(U,ne):d(ne,U);j+=ee,c[ve][Z]=-ee,c[ve][E]=ee}b[Z]={min:(j+1)/-2},b[E]={min:(j-1)/2}}}}let h=Object.keys(c).length,N=Object.keys(b).length;if(e.check!=="oom"&&h>2e3)throw D`size of dag to decrossOpt is too large and will likely crash instead of complete; you probably want to use a cheaper decrossing strategy for sugiyama like \`sugiyama().decross(decrossTwoLayer())\`, but if you still want to continue you can suppress this check with \`sugiyama().decross(decrossOp().check("oom"))\``;if(e.check==="fast"&&(h>1e3||N>5e3))throw D`size of dag to decrossOpt is too large and will likely not complete; you probably want to use a cheaper decrossing strategy for sugiyama like \`sugiyama().decross(decrossTwoLayer())\`, but if you still want to continue you can suppress this check with \`sugiyama().decross(decrossOp().check("slow"))\``;let v=fe("opt","min",c,b,y);if(!v.bounded)throw te`optimization result was not bounded`;for(let k of i)k.sort((w,S)=>{let O=s.get(w),I=s.get(S);return O<I?v[d(O,I)]||-1:-(v[d(I,O)]||-1)})}function n(i){return i===void 0?e.check:Bn(R(T({},e),{check:i}))}t.check=n;function r(i){return i===void 0?e.dist:Bn(R(T({},e),{dist:i}))}return t.dist=r,t.d3dagBuiltin=!0,t}function Yi(...e){if(e.length)throw D`got arguments to decrossOpt(${e}); you probably forgot to construct decrossOpt before passing to decross: \`sugiyama().decross(decrossOpt())\`, note the trailing "()"`;return Bn({check:"fast",dist:!1})}function Vn(e,t){function n(o,a){let s=0,u=o.topological(e.rank);for(let d of u)d.uy=void 0;t.topDown&&u.reverse();for(let d of u){let l=Math.max(a(void 0,d),...A(se(d.parents(),d.children()),f=>{var p;return((p=f.uy)!=null?p:-1/0)+a(f,d)}));s=Math.max(s,l+a(d,void 0)),d.y=l}for(let d of u.reverse()){let l=Math.min(...A(be(se(d.parents(),d.children()),f=>d.y<f.y),f=>f.y-a(f,d)));l!==1/0&&(d.y=l)}if(t.topDown)for(let d of u)d.y=s-d.y;return s}function r(o){if(o===void 0)return e.rank;{let a=e,{rank:s}=a,u=V(a,["rank"]);return Vn(R(T({},u),{rank:o}),t)}}n.rank=r;function i(o){return o===void 0?t.topDown:Vn(e,R(T({},t),{topDown:o}))}return n.topDown=i,n.d3dagBuiltin=!0,n}function Xi(){}function ea(...e){if(e.length)throw D`got arguments to layeringLongestPath(${e}); you probably forgot to construct layeringLongestPath before passing to layering: \`sugiyama().layering(layeringLongestPath())\`, note the trailing "()"`;return Vn({rank:Xi},{topDown:!0})}function wo(e){function t(r,i){let o=0,a;for(let s of r.topological(e.rank))o+=i(a,s),s.y=o,a=s;return o+=i(a,void 0),o}function n(r){if(r===void 0)return e.rank;{let i=e,{rank:o}=i,a=V(i,["rank"]);return wo(R(T({},a),{rank:r}))}}return t.rank=n,t.d3dagBuiltin=!0,t}function ta(){}function na(...e){if(e.length)throw D`got arguments to layeringTopological(${e}); you probably forgot to construct layeringTopological before passing to layering: \`sugiyama().layering(layeringTopological())\`, note the trailing "()"`;return wo({rank:ta})}function ke(e,t){return`${e} => ${t}`}function Do(e,t,n,r,{dist:i,check:o}){let a=i?e.filter(h=>!Fn(r(h))):[],s=new Map;if(i)for(let h of e)for(let[N]of r(h))Re(s,N,h);let u=Math.max(e.length*(e.length-1)/2,0),l=qn(s.values(),(h,N)=>h+N.length*N.length,0)*a.length/4,f={},p={},m={},g=1/(l+1),c=g/(u+1);for(let[h,N]of K(q(e,0,e.length-1))){let v=t.get(N);for(let L of q(e,h+1)){let k=t.get(L),w=ke(v,k);m[w]=1,p[w]={max:1},f[w]={opt:c,[w]:1}}}for(let[h,N]of K(q(e,0,e.length-1))){let v=t.get(N);for(let[L,k]of K(q(e,h+1))){let w=t.get(k);for(let S of q(e,h+L+2)){let O=t.get(S),I=ke(v,w),z=ke(v,O),M=ke(w,O),$=`tri: ${v} - ${w} - ${O}`,_=`${$} +`,W=`${$} -`;p[_]={max:1},f[I][_]=1,f[z][_]=-1,f[M][_]=1,p[W]={min:0},f[I][W]=1,f[z][W]=-1,f[M][W]=1}}}for(let[h,N]of K(q(e,0,e.length-1))){let v=t.get(N);for(let L of q(e,h+1)){let k=t.get(L),w=ke(v,k);for(let[S,O]of r(N)){let I=n.get(S);for(let[z,M]of r(L)){if(S===z)continue;let $=n.get(z);f[w].opt+=Math.sign($-I)*O*M}}}}for(let h of a){let N=t.get(h);for(let v of s.values())for(let[L,k]of K(v)){let w=t.get(k);for(let S of q(v,L+1)){let O=t.get(S),I=`dist: ${w} - ${N} - ${O}`,z=`${I} :normal`,M=`${I} :reversed`;f[I]={opt:g,[z]:1,[M]:1};let $=0;for(let[_,W]of[[w,N],[w,O],[N,O]]){let B=_<W?ke(_,W):ke(W,_),Z=Math.sign(_-W);$+=Z,f[B][z]=-Z,f[B][M]=Z}p[z]={min:($+1)/-2},p[M]={min:($-1)/2}}}}let b=Object.keys(f).length,y=Object.keys(p).length;if(o!=="oom"&&b>1200)throw D`size of dag to twolayerOpt is too large and will likely crash instead of complete; you probably want to use a cheaper twolayer strategy for sugiyama like \`decrossTwoLayer(twolayerAgg())\`, but if you still want to continue you can suppress this check with \`decrossTwoLayer().order(twolayerOpt().check("oom"))\``;if(o==="fast"&&(b>400||y>1e3))throw D`size of dag to twolayerOpt is too large and will likely not finish; you probably want to use a cheaper twolayer strategy for sugiyama like \`decrossTwoLayer(twolayerAgg())\`, but if you still want to continue you can suppress this check with \`decrossTwoLayer().order(twolayerOpt().check("slow"))\``;return fe("opt","min",f,p,m)}function $n(e){function t(i,o,a){let[s,u]=a?[o,i]:[i,o],d=a?c=>c.parentCounts():c=>c.childCounts(),l=new Map(A(s,(c,b)=>[c,b])),f=new Map(A(u,(c,b)=>[c,b])),p={},m=[];for(let c of s)if(f.has(c)){let b=Do(m,l,f,d,e);Object.assign(p,b),m.length=0}else m.push(c);let g=Do(m,l,f,d,e);Object.assign(p,g),s.sort((c,b)=>{let y=l.get(c),h=l.get(b);return y<h?p[ke(y,h)]||-1:-(p[ke(h,y)]||-1)})}function n(i){return i===void 0?e.check:$n(R(T({},e),{check:i}))}t.check=n;function r(i){return i===void 0?e.dist:$n(R(T({},e),{dist:i}))}return t.dist=r,t.d3dagBuiltin=!0,t}function ra(...e){if(e.length)throw D`got arguments to twolayerOpt(${e}); you probably forgot to construct twolayerOpt before passing to order: \`decrossTwoLayer().order(twolayerOpt())\`, note the trailing "()"`;return $n({check:"fast",dist:!1})}function oa(e){let{width:t,height:n}=e;function r(i,o){let{width:a,height:s}=o,u=t/a,d=n/s;for(let l of i.nodes())l.x*=u,l.y*=d;for(let l of i.links())for(let f of l.points)f[0]*=u,f[1]*=d;return e}return r}function ia(e){let[t,n]=e;function r(i,o){for(let a of i.links()){let[s,u,d,l]=a.points;if(l!==void 0)throw D`link points had more than three points: ${a.points.length}; tweakGridPoints can only be applied to grid layouts`;if(d!==void 0){let[f,p]=s,[m,g]=u,[c,b]=d;a.points=[s,[m+t*Math.sign(f-m),g+n*Math.sign(p-g)],u,[m+t*Math.sign(c-m),g+n*Math.sign(b-g)],d]}}return o}return r}function aa(e,t){for(let i of e.nodes()){let o=i.x;i.x=i.y,i.y=o}for(let i of e.links())for(let o of i.points){let[a]=o;o[0]=o[1],o[1]=a}let{width:n,height:r}=t;return{width:r,height:n}}function sa(e,t){let{height:n}=t;for(let r of e.nodes())r.y=n-r.y;for(let r of e.links())for(let i of r.points)i[1]=n-i[1];return t}function ua(e,t){let{width:n}=t;for(let r of e.nodes())r.x=n-r.x;for(let r of e.links())for(let i of r.points)i[0]=n-i[0];return t}function da(e="diagonal"){if(e==="diagonal")return aa;if(e==="vertical")return sa;if(e==="horizontal")return ua;throw D`invalid tweakFlip style: ${e}`}function So(e,t,n,r){let[i,o]=e,[a,s]=t,[u,d]=n,[l,f]=r,p=i-a/2,m=i+a/2,g=o-s/2,c=o+s/2;function b(N,v){let L=0;return N<p?L|=1:N>m&&(L|=2),v<g?L|=4:v>c&&(L|=8),L}let y=b(u,d),h=b(l,f);if(!h)throw D`line from [${u}, ${d}] -> [${l}, ${f}] ended inside rectangle centered at [${i}, ${o}] with size [${a}, ${s}]`;for(;;){if(h){if(y&h)return[u,d];h&8?(l=u+(l-u)*(c-d)/(f-d),f=c):h&4?(l=u+(l-u)*(g-d)/(f-d),f=g):h&2?(f=d+(f-d)*(m-u)/(l-u),l=m):(f=d+(f-d)*(p-u)/(l-u),l=p)}else return[l,f];h=b(l,f)}}function la(e,t,n,r){let[i,o]=e,[a,s]=t,[u,d]=n,[l,f]=r,p=a/2,m=s/2,g=l-u,c=u-i,b=f-d,y=d-o,h=p*p,N=m*m,v=h*b*b+N*g*g,L=g*y-b*c,k=v-L*L;if(k>=0){let w=p*m*Math.sqrt(k),S=g*c*N+b*y*h,O=(S+w)/-v,I=(S-w)/-v;if(O<1&&1<I)throw D`line from [${u}, ${d}] -> [${l}, ${f}] ended inside ellipse at [${i}, ${o}] with size [${a}, ${s}]`;return 0<=I&&I<=1?[I*g+u,I*b+d]:[u,d]}else return[u,d]}function fa(e,t=So){function n(r,i){for(let o of r.nodes()){let a=[o.x,o.y],s=typeof e=="function"?e(o):e;for(let{points:u}of o.parentLinks()){let[d,l]=u.slice(-2),f=t(a,s,l,d);u.splice(-1,1,f)}for(let{points:u}of o.childLinks()){let[d,l]=u,f=t(a,s,d,l);u.splice(0,1,f)}}return i}return n}function*ca(e){for(let t of e.parentLinks()){let{source:n}=t;n.y<e.y&&(yield[n,e,t])}for(let t of e.childLinks()){let{target:n}=t;n.y<e.y&&(yield[n,e,t])}}function Oo(e,t){let n=e.findIndex(r=>r<t);return n>=0?n:e.length}function Io(e,t){let n=[];for(let[a,s]of Q(e)){let u=!1;for(let d of ca(s)){let[l]=d;a===l&&!u?u=!0:n.push(d)}}n.sort(([a,s],[u,d])=>s.y-d.y||u.y-a.y);let r=[],i=[],o=new Map;for(let[a,s,u]of n){let d=Oo(i,a.y),l=Oo(r,a.y);d<l?(o.set(u,-d-1),i[d]=s.y-t):(o.set(u,l+1),r[l]=s.y-t)}return o}function pa(e){return typeof e=="function"?e:()=>e}function at(e,t){function n(s){var d;let u;if(!s.nnodes())u={width:0,height:0};else{let{xgap:l,ygap:f}=t,p=pa(e.nodeSize),m=[...s.topological(e.rank)],g=-f,c=0;for(let k of m){let[w,S]=p(k);if(w<=0||S<=0)throw D`constant nodeSize must be positive, but got: [${w}, ${S}]`;c=Math.max(c,w),g+=f,k.y=g+S/2,g+=S}let b=g,y=Math.min(...A(Q(m),([k,w])=>(w.y-k.y)/(k.nchildLinksTo(w)+k.nparentLinksTo(w)>1?2:1))),h=Io(m,y*1.5),N=0,v=0;for(let k of h.values())N=Math.min(N,k),v=Math.max(v,k);let L=-N*l+c/2;for(let k of m)k.x=L;for(let k of s.links()){let w=(d=h.get(k))!=null?d:0,{source:S,target:O,points:I}=k;if(I.splice(0),I.push([S.x,S.y]),w!==0){let z=(w-N)*l+(w>0?c:0),M=S.y+y,$=O.y-y;$-M>.001*y?I.push([z,M],[z,$]):I.push([z,M])}I.push([O.x,O.y])}u={width:(v-N)*l+c,height:b}}for(let l of e.tweaks)u=l(s,u);return u}function r(s){if(s===void 0)return e.rank;{let u=e,{rank:d}=u,l=V(u,["rank"]);return at(R(T({},l),{rank:s}),t)}}n.rank=r;function i(s){if(s===void 0)return e.tweaks;{let u=e,{tweaks:d}=u,l=V(u,["tweaks"]);return at(R(T({},l),{tweaks:s}),t)}}n.tweaks=i;function o(s){if(s===void 0)return e.nodeSize;if(typeof s!="function"&&(s[0]<=0||s[1]<=0)){let[d,l]=s;throw D`constant nodeSize must be positive, but got: [${d}, ${l}]`}else{let u=e,{nodeSize:d}=u,l=V(u,["nodeSize"]);return at(R(T({},l),{nodeSize:s}),t)}}n.nodeSize=o;function a(s){if(s!==void 0){let[u,d]=s;if(u<0||d<0)throw D`gap width (${u}) and height (${d}) must be non-negative`;return at(e,R(T({},t),{xgap:u,ygap:d}))}else{let{xgap:u,ygap:d}=t;return[u,d]}}return n.gap=a,n}function ha(...e){if(e.length)throw D`got arguments to zherebko(${e}), but constructor takes no arguments; these were probably meant as data which should be called as \`zherebko()(...)\``;return at({rank:()=>{},nodeSize:[1,1],tweaks:[]},{xgap:1,ygap:1})}export{kn as aggMean,$i as aggMedian,uo as aggWeightedMedian,Tt as cachedNodeSize,qi as coordCenter,Fi as coordGreedy,Ji as coordQuad,Ln as coordSimplex,Qi as coordTopological,Vt as decrossDfs,Yi as decrossOpt,On as decrossTwoLayer,ue as graph,ei as graphConnect,ri as graphHierarchy,Jo as graphJson,ai as graphStratify,li as grid,an as laneGreedy,Oi as laneOpt,In as layerSeparation,ea as layeringLongestPath,Tn as layeringSimplex,na as layeringTopological,la as shapeEllipse,So as shapeRect,Sn as sizedSeparation,bn as splitNodeSize,Rn as sugiNodeLength,Ei as sugifyCompact,Gn as sugifyLayer,ji as sugiyama,da as tweakFlip,ia as tweakGrid,fa as tweakShape,oa as tweakSize,vn as twolayerAgg,Dn as twolayerGreedy,ra as twolayerOpt,Mn as unsugify,ha as zherebko};
